            ...
            <Field className="flex gap-5.25 mt-2">
              <div className="h-[43px] w-[43px] rounded-[8px] bg-[#E8E8E8] flex justify-center items-center">
                {avatar ? (
                  ...
                  <img src={avatar_icon} alt="avatar" width={17} height={21} />
                )}
              </div>
              <ButtonDefault
        ...
        <div>
          ...
          <Field>
            <InputDefault
              ...
              value={likes_count || ""}
              onUpdateValue={(e) => dispatch(setLikes(Number(e.target.value)))}
            />
            <Field className="flex flex-col mt-2">
              ...
              <Textarea
                ...
                name="whats_new"
                value={comments_text}
                onChange={(e) => dispatch(setCommentsText(e.target.value))}
              ></Textarea>
            </Field>
          </Field>
        </div>
      ...
      <div className="flex-1/2">
        <div className="flex flex-col gap-2">
          <InputDefault
            ...
            onUpdateValue={(e) => dispatch(setDeveloperName(e.target.value))}
          />
          <Field className="flex flex-col mt-2">
            {label("Текст ответа")}
            <Textarea
